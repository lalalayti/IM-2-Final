...
<body>
    <nav class="sidebar" style="width:20%">
        ...
        <a href="login.PHP" class="sidebar-signout" style="margin-top: auto; margin-bottom:10px;"><img class="out-icon" style="height: 25px;" src="img/signin.svg" alt="Sign-In">Sign In</a>
    </nav>
